...
// 登录以后签发jwt
//func TokenNext(c *gin.Context, user userModel.SysUser) {
...
//		return
//	}
//	if err, jwtStr := GetRedisJWT(user.UserName); err == redis.Nil {
//		if err := SetRedisJWT(token, user.UserName); err != nil {
...
//		response.FailWithMessage("设置登录状态失败", c)
//	} else {
//		var blackJWT jwtModel.JwtBlacklist
//		blackJWT.Jwt = jwtStr
//		if err := JsonInBlacklist(blackJWT); err != nil {
